...
*
*  This software can be reused with other hardware configuration by only changing the signal 
*  mapping.
* 
...
/* Configuration for a stepper motor of 400 pulses per revolution, no planetary reduction
* built-in.
* 
*  This motor is intented to be used with a butterfly capacitor. This capacitor type
*  goes from minimum capacity to maximum with a 90 deg rotation = 1/4 of a full rotation.
*  Coupling to the capacitor is directly to the shaft (no additional mechanical reduction).
*
...
* 
*  This motor is intented to be used with a vacuum capacitor of 16 turns and coupled
*  directly to the capacitor shaft (no additional mechanical reduction).
* 
*  Microswitches configured for maximum microstepping for minimum vibrations.
*  switches 1 - LOW
*           2 - LOW
